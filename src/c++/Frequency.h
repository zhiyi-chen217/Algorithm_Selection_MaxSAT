...
#define TRAIN_RESULT_FILE_NAME "all_ordering_zero_one_train_result.csv"
#define TEST_FEATURE_FILE_NAME "test_dimacs_feature.csv"
#define TEST_RESULT_FILE_NAME "all_ordering_zero_one_test_dimacs_result.csv"
#define TEST_SCORE_FILE_NAME "all_ordering_zero_one_test_dimacs_result.csv"
#define PRED_FILE_NAME "predicate_graph_color.csv"
#define SBS_IND 0
#define N_ITER 1
#define N_PRED_START 20
#define N_PRED_END 100
#define INTERVAL 5
